...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[100dvh] flex items-center justify-center bg-[#050505] overflow-hidden pt-28 pb-12 lg:pt-32 lg:pb-0">
      
      {/* Background Texture - Minimal Noise */}
      <div className="absolute inset-0 bg-noise opacity-[0.03] pointer-events-none" />

      {/* Container Principal */}
      <div className="max-w-[1400px] mx-auto w-full relative z-10 px-6 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center h-full">
        ...
        <div className="lg:col-span-7 flex flex-col justify-center relative z-30 order-2 lg:order-1">
            ...
            <motion.div 
                ...
                className="flex items-center gap-3 mb-4 lg:mb-8 pl-1"
            >
            ...
            <h1 className="font-display font-medium tracking-tighter leading-none text-white mix-blend-normal mb-8 lg:mb-10">
                {/* Linha 1: Design que */}
                <div className="overflow-hidden pb-1">
                    <motion.span 
                        ...
                        className="block text-3xl md:text-5xl lg:text-6xl xl:text-[4.5rem] text-gray-400 font-light mb-1 lg:mb-2 tracking-tight"
                    >
                        Design que
                    </motion.span>
                </div>
                ...
                {/* Linha 2: CONSTRÓI */}
                <div className="overflow-hidden pb-1 lg:pb-2 lg:-mt-2">
                    <motion.span 
                        initial={{ y: "100%" }}
                        animate={{ y: 0 }}
                        transition={{ duration: 0.8, delay: 0.1, ease: [0.16, 1, 0.3, 1] }}
                        className="block text-5xl md:text-7xl lg:text-[5.5rem] xl:text-[7.5rem] uppercase text-white font-bold ml-[-0.05em] leading-[0.9]"
                    >
                        CONSTRÓI
                    </motion.span>
                </div>
                ...
                {/* Linha 3: AUTORIDADE. */}
                <div className="overflow-hidden relative pb-1 lg:pb-2 lg:-mt-4">
                     <motion.span 
                        initial={{ y: "100%" }}
                        animate={{ y: 0 }}
                        transition={{ duration: 0.8, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
                        className="block text-5xl md:text-7xl lg:text-[5.5rem] xl:text-[7.5rem] uppercase text-gray-600 font-light ml-[-0.05em] leading-[0.9]"
                    >
                        AUTORIDADE.
                    </motion.span>
                </div>
            ...
            <motion.div 
                ...
                className="mt-2 lg:mt-6 max-w-md pl-1 hidden md:block"
            >
                <p className="text-base lg:text-lg text-gray-400 font-light leading-relaxed mb-8">
        ...
        <div className="lg:col-span-5 relative h-[35vh] md:h-[50vh] lg:h-[80vh] flex items-end lg:items-center justify-center order-1 lg:order-2 lg:-mr-12 w-full">
            <motion.div 
            ...
            >
                 ...
                 <div className="absolute bottom-4 right-4 lg:bottom-12 lg:right-12 text-right z-20">
        ...
        <motion.div 
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 0.6, duration: 1 }}
            className="md:hidden order-3 col-span-1 mt-0 pl-1 pb-8 relative z-30"
        >
